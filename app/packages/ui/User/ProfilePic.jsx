...
import { GetProfilePicById, GetUserNameById } from "@/app/packages/supabase/SupabaseUserData.js";
import { useRequireAuth } from "@/app/auth/hooks/useRequireAuth";
import { SetKeyLocalStorage, GetKeyLocalStorage } from "@/app/packages/caching/LocalStorageRouter";
...
const ProfilePic = ({
    ...
    useEffect(() => {
        ...
        const localUsername = GetKeyLocalStorage("username");

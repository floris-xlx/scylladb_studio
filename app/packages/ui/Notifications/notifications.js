const notifications = [
    ...
    {
        "type": "SubmittedBugReport",
        "title": "Bug report successfully submitted",
        "message": "Thank you for helping us improve our platform. We will look into the issue you reported and get back to you as soon as possible.",
        "icon": "HeartIcon",
    },
    {
        "type": "FailedBugReport",
        "title": "Failed to submit bug report",
        "message": "We encountered an error while submitting your bug report. Please try again later or contact support for assistance.",
        "icon": "HeartIcon",
    }
]

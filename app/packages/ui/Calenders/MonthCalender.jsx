...
import { currentYear, getCurrentMonth, daysInAMonth } from '@/app/packages/hooks/datetime/RelativeDate.js'
  ...
  return (
    <div className="ml-[10px] sm:ml-[0px] mt-[23px]">
      <div className=" rounded-md  h-[165px] equity-curve-width sm:w-full">
        ...
        <div className="border border-primary bg-secondary h-[400px]  rounded-md mt-4 flex flex-col w-full">
          {/* the dates header */}
          ...
          <div className="flex flex-row w-full h-[40px]">
            <div className="border-bottom-color w-full h-[40px] flex items-center justify-center">
              <h3 className="text-center font-semibold text-primary-secondary">
                Saturday
              </h3>
            </div>
            ...
            <div className="border-bottom-color w-full h-[40px] flex items-center justify-center border-left-color">
              <h5 className="text-center font-semibold text-primary-secondary text-sm">
                Friday
              </h5>
            </div>
          </div>
          ...
          <div className="grid grid-cols-7 h-full w-full">
            {Array.from({ length: daysInMonth }, (_, i) => (
              <div key={i} className="border border-primary flex justify-left items-left pt-2 pl-2">
                <div className="flex flex-col">
                  <div className="text-left font-semibold text-primary-secondary">
                    {i + 1}
                  </div>
                  <div className="text-left text-sm font-normal text-primary-accent mt-2">
                    1 trade
                  </div>
                </div>

...
import {
  ...
  firstDayOfMonth,
  daysInAMonth
} from '@/app/packages/hooks/datetime/RelativeDate.js'
import { months } from '@/app/packages/workerdata/months.js'
...
export default function Example({ setSelectedDate }) {
  ...
  return (
    <div>
      <h2 className="inline-block text-sm font-medium text-primary-accent">Select date</h2>
      <div className="">
        <div className="mt-10 text-center">
          <div className="flex items-center text-gray-900">
            ...
            <div className="flex-auto font-semibold text-primary-accent h-[35px]">
              {title}
            </div>
          ...
          <div className="isolate mt-2 grid grid-cols-7 gap-px rounded-lg bg-secondary border border-primary text-sm shadow">
            {days.map((day, dayIdx) => (
              <button
                key={day.date}
                type="button"
                className={classNames(
                  ...
                  day.isCurrentMonth ? 'bg-secondary' : 'opacity-30 cursor-default pointer-events-none select-none',

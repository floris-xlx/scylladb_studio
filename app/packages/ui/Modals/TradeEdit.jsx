...
import { GetTradeMetadatByTradeHash, UpdateTradeByTradeHash } from "@/app/packages/supabase/SupabaseUserData.js";
                    ...
                    {(onClose) => (
                        <>
                            ...
                            <ModalBody className="background-color">
                                <p className="font-normal text-primary-secondary text-sm">
                                ...
                                <div>
                                        ...
                                        <div className="mt-1">
                                            ...
                                            >
                                                <input
                                                    ...
                                                    disabled={true}
                                                    value={tradeHash}
                                                    className="block w-full appearance-none rounded-md input-field px-3 py-2  shadow-sm focus:outline-none focus:ring-2  focus:ring-indigo-500 sm:text-sm font-medium cursor-default select-none text-primary-accent"
                                                />
                                            </ToolTipNext>
                                    ...
                                    <div>
                                        <div>
                                            <label
                                                ...
                                                className="block text-sm font-medium text-primary-accent mt-2"
                                            >
                                                Position size
                                            </label>
                                            <div className="mt-1">
                                    ...
                                    <div className="flex flex-wrap gap-2 mx-auto flex-col w-full">
                                        ...
                                        {isLoadingData ? (
                                            ...
                                            >
                                                <Tab key="Win" title={<><ArrowTrendingUpIcon className="inline-block w-5 h-5 mr-1" />Win</>} />
                                                <Tab key="Loss" title={<><ArrowTrendingDownIcon className="inline-block w-5 h-5 mr-1" />Loss</>} />
                                                <Tab key="Running" title={<><ArrowsPointingOutIcon className="inline-block w-5 h-5 mr-1" />Running</>} />
                                                <Tab key="Unknown" title={<><QuestionMarkCircleIcon className="inline-block w-5 h-5 mr-1" />Unknown</>} />
                                            </Tabs>
                                        )}
                                    </div>
                                </div>

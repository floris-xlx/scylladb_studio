...
import { isWordBanned } from '@/app/packages/hooks/profanityWords.js';
...
import {
    ...
    AddCurrencyById
} from "@/app/packages/supabase/SupabaseUserData.js";

// internal api
import CreateStrategyId from "@/app/packages/api/StrategyApi.js";
...
const StrategyCreationForm = (
    ...
    }, [strategyHash, strategyName, currency, userId]);


    return (
        <div>
            <form className="flex flex-col">
                <h2 className="font-semibold leading-6 text-primary text-xl flex mx-auto">
                    Strategy creation
                </h2>
                ...
                <div className="mt-8  flex mx-auto flex-col">
                    <label
                        ...
                        className="text-sm font-medium text-secondary flex mx-auto"
                    >
                        Strategy name
                    </label>
                    <div className="mt-1">
                ...
                <div className="flex flex-wrap gap-4 mx-auto mt-8 flex-col">
                    <label
                        htmlFor="currency"
                        className="text-sm font-medium text-secondary mx-auto flex"
                    >
                        Preferred currency
                    </label>
                    {/* TABS */}

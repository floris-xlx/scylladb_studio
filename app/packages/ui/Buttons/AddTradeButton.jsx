...
import DatePickerSmall from "@/app/packages/ui/Calenders/DatePickerSmall.jsx";
import ChartUploadButton from "@/app/packages/ui/Buttons/ChartUploadButton.jsx";
import PairnameAutocomplete from "@/app/packages/ui/AutoComplete/PairnameAutoComplete.jsx";
import TimePickerSmall from "@/app/packages/ui/Calenders/TimePickerSmall.jsx";
import IsNumberNegative from "@/app/packages/hooks/checkers/IsNumberNegative.js";
import { getTradingSession } from "@/app/packages/hooks/datetime/RelativeDate.js";
import { AddTradeById } from "@/app/packages/supabase/SupabaseUserData.js";
import InputField from "@/app/packages/ui/InputFields/InputField.jsx";
import {
  Modal,
  ModalContent,
  ModalHeader,
                ...
                <ModalBody className="background-color">
                  <p>
                    ...
                    {secondTakeProfit === null ? (
                      <div>
                        <button className="group p-2 sm:p-2 block cursor-pointer text-center border-2 border-dotted border-gray-200 rounded-lg focus-within:outline-none focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2  w-full border border-primary hover:border-[var(--text-primary-accent-secondary)] transition mt-2"
                          onClick={handleSecondTakeProfit}
                        >
                          <PlusIcon className="mx-auto icon-color size-100 h-5 w-5" aria-hidden="true" />
                          <span className="mt-2 block text-sm text-primary-accent font-normal">

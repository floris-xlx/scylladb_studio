...
import CreateTradeHash from '@/app/packages/api/TradeApi';
...
export async function GetAllShoes() {
  ...
  console.log('GetAllShoes Data:', data);
  console.log('GetAllShoes Error:', error);
...
export async function AddShoeToStock(shoe_size, shoe_hash, shoe_condition, shoe_description, shoe_price) {
  const { data, error } = await supabase 
    .from('froste_stock')
    .insert([
      { 
  ...
  console.log('AddShoeToStock Data:', data);
...
export async function GetAllShoesInStock() {
  const { data, error } = await supabase
    .from('froste_stock')
    .select('*');

  console.log('GetAllShoesInStock Data:', data);
  console.log('GetAllShoesInStock Error:', error);
...
export async function GetShoeImagesByShoeHash(shoe_hash) {
  if (shoe_hash === undefined || shoe_hash === null) {
    return [];
  }

  const { data, error } = await supabase
    .from('froste_shoes')
    .select('shoe_pictures, shoe_name, shoe_color')
    .eq('shoe_hash', shoe_hash);

  console.log('GetShoeImagesByShoeHash Data:', data);
  console.log('GetShoeImagesByShoeHash Error:', error);
